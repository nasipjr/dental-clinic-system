...
INSERT INTO `appointment` VALUES (1713,349,'2026-08-14 19:09:43','جلسة جديدة سريعة','Done','2026-08-14 19:09:43',19,30),(1721,353,'2026-08-14 20:13:36','جلسة جديدة سريعة','Done',NULL,19,30),(1722,349,'2026-08-14 20:15:51','جلسة جديدة سريعة','Done','2026-08-14 20:15:51',19,30),(1724,354,'2026-08-14 20:18:31','جلسة جديدة سريعة','Done',NULL,19,30),(1725,352,'2026-08-14 20:20:38','جلسة جديدة سريعة','Done','2026-08-14 20:20:38',19,30),(1726,355,'2026-08-14 20:22:31','جلسة جديدة سريعة','Done','2026-08-14 20:22:31',19,30);
...
INSERT INTO `invoice` VALUES (370,1713,349,'2026-08-14 19:10:06',0.00,'value',0.00,0.00,NULL),(371,1724,354,'2026-08-14 20:18:31',0.00,'value',0.00,0.00,NULL),(372,1725,352,'2026-08-14 20:21:39',0.00,'value',0.00,0.00,NULL),(373,1726,355,'2026-08-14 20:22:59',0.00,'value',0.00,0.00,NULL);
...
INSERT INTO `patient` VALUES (349,'mr','نسيب','جبارة',NULL,'2002-06-10','Male','+963958948727','kh.nasipdragon@gmail.com','اللاذقية استراد الزراعة','اللاذقية',NULL,NULL,'سوريا','لا يوجد','تحسس من الديكلون',NULL,'مهندس',NULL,NULL,'932284186',1,NULL),(350,NULL,'Test','Pat',NULL,NULL,'Male','0912345678',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(351,NULL,'Test','Pat',NULL,NULL,'Male','0912345678',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(352,NULL,'Test','Pat',NULL,NULL,'Male','0912345678',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(353,NULL,'Test','Pat',NULL,NULL,'Male','0912345678',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(354,NULL,'Test','Pat',NULL,NULL,'Male','0912345678',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL),(355,'ms','جنا','عديرة',NULL,NULL,'Female','+963938589133','janaodera0934099489@gmail.com','اللاذقية عين ام ابراهيم','اللاذقية',NULL,NULL,'Syria','','',NULL,NULL,NULL,NULL,NULL,1,NULL);
...
INSERT INTO `treatment` VALUES (513,1713,'2026-08-14 19:10:06','جلسة سحب عصب وتنظيف قنوات','18','',200000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL),(514,1713,'2026-08-14 19:19:03','قلع سن عادي','17','',130000.00,1,1,50000.00,'تخدير ارتشاحي (إبرة قصيرة)',19,NULL,NULL,NULL,NULL),(515,1713,'2026-08-14 19:26:47','معالجة ما بعد القلع','17','',30000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL),(516,1721,'2026-08-14 20:13:36','فحص دوري واستشارة','11-48','Clinical Examination, Consultation & Treatment Planning',25000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL),(517,1722,'2026-08-14 20:15:51','فحص دوري واستشارة','11-48','جلسة فحص واستشارة سريرية وتحديد خطة العلاج',25000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL),(518,1724,'2026-08-14 20:18:31','جلسة فحص و استشارة',NULL,'Clinical Examination, Consultation & Treatment Planning',50000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL),(519,1725,'2026-08-14 20:20:38','جلسة فحص و استشارة',NULL,'جلسة فحص واستشارة سريرية وتحديد خطة العلاج',50000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL),(520,1726,'2026-08-14 20:22:59','حشوة تجميلية','21','',200000.00,0,0,0.00,NULL,19,NULL,NULL,NULL,NULL);
...
--
-- Table structure for table `treatment_plan_item`
--
...
CREATE TABLE `treatment_plan_item` (
  ...
  `completed_treatment_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `patient_id` (`patient_id`),
  KEY `completed_treatment_id` (`completed_treatment_id`),
  CONSTRAINT `treatment_plan_item_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient` (`id`) ON DELETE CASCADE,
  CONSTRAINT `treatment_plan_item_ibfk_2` FOREIGN KEY (`completed_treatment_id`) REFERENCES `treatment` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `treatment_plan_item`
--

LOCK TABLES `treatment_plan_item` WRITE;
/*!40000 ALTER TABLE `treatment_plan_item` DISABLE KEYS */;
INSERT INTO `treatment_plan_item` VALUES (3,349,'15','وتد فايبر مع حشوة بناء',100000.00,'','Planned','2026-08-14 20:06:28',NULL,NULL),(4,349,'16','حشوة ضوئية كومبوزيت (سطح واحد)',60000.00,'','Planned','2026-08-14 20:07:01',NULL,NULL),(5,349,'16','تاج زيركون / بورسلين',200000.00,NULL,'Planned','2026-08-14 20:12:15',NULL,NULL),(6,349,'14','قلع سن عادي',80000.00,'','Planned','2026-08-14 20:16:07',NULL,NULL),(7,352,'28','جلسة سحب عصب وتنظيف قنوات',200000.00,'','Planned','2026-08-14 20:21:00',NULL,NULL),(8,352,'27','حشوة ضوئية كومبوزيت (عدة سطوح)',85000.00,'','Planned','2026-08-14 20:21:23',NULL,NULL),(9,355,'28','جلسة سحب عصب وتنظيف قنوات',200000.00,'','Planned','2026-08-14 20:22:40',NULL,NULL);
...
-- Dump completed on 2026-08-15  3:54:17
