    ...
    window.deleteUser = function (userId) {
        ...
        csrfInput.value = "ImRkZjcyNDI4MTc4ODUxNDY5OTgzOTI1ZjI1OTViZTBkM2RhMjBkNjki.anUpGQ.xanou8RQ-9wvX4taeBz-wRrHk_Q";
    ...
    window.createBackup = function () {
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = "/settings/backups/create";
        const csrfInput = document.createElement('input');
        csrfInput.type = 'hidden';
        csrfInput.name = 'csrf_token';
        csrfInput.value = "ImRkZjcyNDI4MTc4ODUxNDY5OTgzOTI1ZjI1OTViZTBkM2RhMjBkNjki.anUpGQ.xanou8RQ-9wvX4taeBz-wRrHk_Q";
        ...
        document.querySelectorAll('#settings-tabs button[data-bs-toggle="pill"]').forEach(function (btn) {
            btn.addEventListener("shown.bs.tab", function (e) {
                ...
                if (mainForm && targetHash) {
                    mainForm.action = "/settings" + targetHash;
                }
                toggleSaveButton();
            });
        });
