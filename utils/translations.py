...
translations = {
    ...
    "Pending Confirmation": "قيد التثبيت",
    "Confirmed": "مؤكد",
    "Scheduled": "مؤكد",
    "Pending": "قيد التثبيت",
    "In Chair": "في الجلسة",
    "In-Chair": "في الجلسة",
    "Checked In": "في الانتظار",
    "Checked-In": "في الانتظار",
    "Done": "منجز",
    "Cancelled": "تم الإلغاء",
    "Rejected": "تم الرفض",
    "Patient Portal Access Credentials (Doctor & Admin View Only)": "بيانات دخول بوابة المريض (للعرض فقط للطبيب والمدير)",
    "Patient Portal Access Credentials (Doctor &amp; Admin View Only)": "بيانات دخول بوابة المريض (للعرض فقط للطبيب والمدير)",
    "المرضى Portal Access Credentials (طبيب & مدير View Only)": "بيانات دخول بوابة المريض (للعرض فقط للطبيب والمدير)",
    "المرضى Portal Access Credentials (طبيب &amp; مدير View Only)": "بيانات دخول بوابة المريض (للعرض فقط للطبيب والمدير)",
    "Portal Username": "اسم مستخدم البوابة",
    "Portal اسم المستخدم": "اسم مستخدم البوابة",
    "Portal Password": "كلمة مرور البوابة",
    "Portal كلمة المرور": "كلمة مرور البوابة",
    "Telegram Chat ID": "معرّف تيليغرام (Chat ID)",
    "Telegram Chat المعرف": "معرّف تيليغرام (Chat ID)",
    "Enable Automated Reminders": "تفعيل التذكيرات التلقائية",
    "Action Not Allowed": "إجراء غير مسموح به",
    "Error": "خطأ",
    "Failed to end appointment session.": "فشل إنهاء جلسة الموعد.",
    "Failed to end appointment session": "فشل إنهاء جلسة الموعد",
    "Only scheduled appointments can be ended.": "يمكن فقط إنهاء المواعيد المجدولة.",
    "Only scheduled appointments can be ended": "يمكن فقط إنهاء المواعيد المجدولة",
    "This action cannot be completed.": "تعذر إكمال هذا الإجراء.",
    ...
    "Calendar View": "عرض كتقويم",
    "View List": "عرض كقائمة",
    "View Calendar": "عرض كتقويم",
    "Details": "تفاصيل",
    "details": "تفاصيل",
    "View Appointment Details": "عرض تفاصيل الموعد",
    "View Invoice Details": "عرض تفاصيل الفاتورة",
    "View Payment Details": "عرض تفاصيل الدفعة",
    "View Patient Details": "عرض تفاصيل المريض",
    "Failed to view treatment.": "فشل في عرض المعالجة.",
    "View Treatment Details": "عرض تفاصيل المعالجة",
    "Appointment Details": "تفاصيل الموعد",
    "Invoice Details": "تفاصيل الفاتورة",
    "Payment Details": "تفاصيل الدفعة",
    "Patient Details": "تفاصيل المريض",
    "Treatment Details": "تفاصيل المعالجة",
    ...
    "Any Available": "أي طبيب متاح",
    "Admin User": "المدير الرئيسي",
    "Sun": "الأحد",
    "Mon": "الاثنين",
    ...
    "Appointment Details": "تفاصيل الموعد",
    "Appointment cancelled successfully and the clinic has been notified.": "تم إلغاء الموعد بنجاح وتم إشعار العيادة.",
    "Appointment cancelled successfully and the clinic has been notified": "تم إلغاء الموعد بنجاح وتم إشعار العيادة.",
    ...
    "Discount cannot exceed the subtotal.": "لا يمكن أن يتجاوز الخصم المجموع الفرعي.",
    "Failed to update discount.": "فشل في تحديث الخصم.",
    ...
    "Patient Debts": "ديون المرضى والمستحقات",
    "Patient Credits": "أرصدة المرضى الدائنة",
    ...
    "Reset": "إعادة تعيين",
    "Reset Clinic": "إعادة ضبط العيادة",
    "Reset Search": "إعادة تعيين البحث",
    "Restore Database Backup": "استعادة نسخة احتياطية",
    "Restore Backup": "استعادة نسخة احتياطية",
    "Restore Latest Backup": "استعادة أحدث نسخة احتياطية",
    "Restore Latest": "استعادة أحدث نسخة",
    "Confirm & Wipe Database": "تأكيد وتصفير العيادة نهائياً",
    "Confirm & Restore Backup": "تأكيد واستعادة البيانات الآن",
    "Confirm & Restore Selected Backup": "تأكيد واستعادة النسخة المحددة",
    "Admin Verification — Reset Clinic": "التحقق الأمني لإعادة ضبط العيادة",
    "Admin Verification — Restore Backup": "تأكيد استعادة نسخة احتياطية",
    "Revenue": "الإيرادات",
    ...
    "Financial Summary": "الملخص المالي",
    "Quick overview of your financial balance": "نظرة عامة على رصيدك المالي",
    "All Settled": "خالص / مسدد بالكامل",
    "Total Invoiced": "إجمالي الفواتير",
    "Total Paid": "إجمالي المدفوعات",
    "Balance Status": "حالة الرصيد",
    "Appointment Calendar": "تقويم المواعيد",
    "Book an Appointment": "حجز موعد",
    "Select a date and time slot from the calendar below. Blocked slots are marked as \"Reserved\".": "اختر التاريخ والوقت المناسب من التقويم أدناه. الأوقات غير المتاحة موضحة كـ \"محجوز\".",
    "Request a New Appointment": "حجز موعد جديد",
    "Here is a summary of your appointment history": "إليك ملخص سجل مواعيدك",
    "You have been logged out successfully.": "تم تسجيل الخروج بنجاح.",
    "You have logged out of the portal.": "تم تسجيل الخروج من البوابة بنجاح.",
    "You do not have permission to access this page.": "ليس لديك صلاحية للوصول إلى هذه الصفحة.",
    "Please log in to access this page.": "يرجى تسجيل الدخول للوصول إلى هذه الصفحة.",
    ...
    # Patient Portal Specific Translations
    "Book Appointment": "حجز موعد",
    "My Billing": "فواتيري",
    "My Medical History": "سجلي الطبي",
    "Medical Record": "السجل الطبي",
    "Your personal clinical file details": "تفاصيل ملفك السريري الشخصي",
    "Total Treatments:": "إجمالي المعالجات:",
    "Uploaded Documents:": "المستندات المرفوعة:",
    "CLINICAL NOTES SUMMARY": "ملخص الملاحظات السريرية",
    "No general medical conditions or allergies recorded.": "لا توجد حالات طبية أو حساسية مسجلة.",
    "My Invoices": "فواتيري",
    "Payment History": "سجل الدفعات",
    "Invoice #": "الفاتورة #",
    "Receipt #": "الإيصال #",
    "No payments yet": "لا توجد دفعات بعد",
    "Treatments & Procedures": "المعالجات والإجراءات",
    "Clinical Documents": "المستندات السريرية",
    "Treatment Date": "تاريخ المعالجة",
    "Procedure Type": "نوع الإجراء",
    "Tooth": "السن",
    "Doctor Notes": "ملاحظات الطبيب",
    "No treatments recorded yet": "لم يتم تسجيل أي معالجات بعد",
    "View Full": "عرض كامل",
    "Download": "تنزيل",
    "No documents or X-rays uploaded yet": "لم يتم رفع أي مستندات أو صور أشعة بعد",
    ...
    "Uploaded Documents": "المستندات المرفوعة",
    "Balance Status": "حالة الرصيد",
    "Back to Billing": "العودة إلى الفواتير",
    ...
    "Today's Revenue": "إيرادات اليوم",
    "Today's Paid": "المدفوع اليوم",
    "Paid Ratio": "نسبة التحصيل",
    "No more upcoming appointments scheduled for today.": "لا توجد المزيد من المواعيد المجدولة لليوم.",
    "waiting sessions": "جلسات قيد الانتظار",
    "done sessions": "جلسات منجزة",
    "invoiced treatments": "المعالجات المفوترة",
    "payments collected": "المدفوعات المحصلة",
    "Stream ID": "معرف البث (Stream ID)",
    "Test Telegram": "اختبار تيليغرام",
    "Send Test SMS": "إرسال رسالة نصية تجريبية",
    "API Auth Token": "رمز مصادقة الواجهة (API Auth Token)",
    "e.g. 123456789": "مثال: 123456789",
    "Send Test Email": "إرسال بريد إلكتروني تجريبي",
    "Syria Compatible": "متوافق مع سوريا",
    "Telegram Bot Token": "رمز بوت تيليغرام (Bot Token)",
    "Email Subject (2h)": "موضوع البريد الإلكتروني (قبل ساعتين)",
    "e.g. +963958948727": "مثال: +963958948727",
    "Test Email Address": "عنوان البريد الإلكتروني للتجربة",
    "e.g. user@gmail.com": "مثال: user@gmail.com",
    "Email Subject (24h)": "موضوع البريد الإلكتروني (قبل 24 ساعة)",
    "CommPeak Credentials": "بيانات اعتماد CommPeak",
    "e.g. doctor@gmail.com": "مثال: doctor@gmail.com",
    "Telegram Bot Settings": "إعدادات بوت تيليغرام",
    "Enable 2-Hour Reminder": "تفعيل تذكير قبل ساعتين",
    "Enable 24-Hour Reminder": "تفعيل تذكير قبل 24 ساعة",
    "Your CommPeak Stream ID": "معرف البث الخاص بك في CommPeak",
    "Available dynamic tags:": "العلامات الديناميكية المتاحة:",
    "e.g. no-reply@clinic.com": "مثال: no-reply@clinic.com",
    "Customize Email Messages": "تخصيص رسائل البريد الإلكتروني",
    "Enter subject for 2h email": "أدخل موضوع البريد الإلكتروني لـ قبل ساعتين",
    "Enter subject for 24h email": "أدخل موضوع البريد الإلكتروني لـ قبل 24 ساعة",
    "Customize Telegram Messages": "تخصيص رسائل تيليغرام",
    "Booking Window Days (in advance)": "أيام نافذة الحجز (مسبقاً)",
    "Enable Email Reminders (Gmail SMTP)": "تفعيل التذكير بالبريد الإلكتروني (Gmail SMTP)",
    "Test Chat ID (Your Telegram Chat ID)": "معرف دردشة الاختبار (Chat ID الخاص بك على تيليغرام)",
    "Enter message template for 2h reminder": "أدخل قالب الرسالة لتذكير قبل ساعتين",
    "Enter message template for 24h reminder": "أدخل قالب الرسالة لتذكير قبل 24 ساعة",
    "e.g. 123456789:ABCdefGHIjklMNOpqrstUVwxyz": "مثال: 123456789:ABCdefGHIjklMNOpqrstUVwxyz",
    "Enter email template body for 2h reminder": "أدخل نص قالب البريد الإلكتروني لتذكير قبل ساعتين",
    "Enter email template body for 24h reminder": "أدخل نص قالب البريد الإلكتروني لتذكير قبل 24 ساعة",
    "Your CommPeak API Auth Token (Bearer token)": "رمز مصادقة الواجهة لـ CommPeak (Bearer token)",
    "Enter your TextPeak API Auth Token and Stream ID.": "أدخل رمز مصادقة TextPeak ومعرف البث.",
    "Number of days in advance patients and staff are allowed to book appointments.": "عدد الأيام مسبقاً التي يُسمح فيها للمرضى والموظفين بحجز المواعيد.",
    "Customize clinic profile, working hours, billing details, and treatment prices.": "تخصيص ملف العيادة، ساعات العمل، تفاصيل الفواتير، وأسعار المعالجات.",
    "Sends reminder emails to patient email addresses using Gmail or any SMTP server.": "إرسال رسائل بريد إلكتروني للتذكير إلى عناوين البريد الإلكتروني للمرضى باستخدام Gmail أو أي خادم SMTP.",
    "Sends text messages to patient mobile numbers via CommPeak gateway (supports Syrian numbers).": "إرسال رسائل نصية قصيرة إلى أرقام هواتف المرضى عبر بوابة CommPeak (تدعم الأرقام السورية).",
    "System Settings": "إعدادات النظام",
    "Enable Cancellation Notification": "تفعيل إشعار الإلغاء",
    "Enable Reschedule Notification": "تفعيل إشعار تعديل الموعد",
    "Enable Cancellation SMS": "تفعيل رسالة الإلغاء القصيرة",
    "Enable Reschedule SMS": "تفعيل رسالة تعديل الموعد القصيرة",
    "Enable Cancellation Email": "تفعيل بريد الإلغاء الإلكتروني",
    "Enable Reschedule Email": "تفعيل بريد تعديل الموعد الإلكتروني",
    "Customize SMS Messages": "تخصيص الرسائل القصيرة (SMS)",
    "Enter message template for cancellation SMS": "أدخل نموذج رسالة الإلغاء القصيرة",
    "Enter message template for reschedule SMS": "أدخل نموذج رسالة تعديل الموعد القصيرة",
    "Enter message template for cancellation": "أدخل نموذج رسالة الإلغاء",
    "Enter message template for reschedule": "أدخل نموذج رسالة تعديل الموعد",
    "Email Subject (Cancel)": "موضوع البريد الإلكتروني (الإلغاء)",
    "Email Subject (Reschedule)": "موضوع البريد الإلكتروني (تعديل الموعد)",
    "Enter subject for cancellation email": "أدخل موضوع بريد الإلغاء",
    "Enter subject for reschedule email": "أدخل موضوع بريد تعديل الموعد",
    "Enter email template body for cancellation": "أدخل نص بريد الإلغاء",
    "Enter email template body for reschedule": "أدخل نص بريد تعديل الموعد",
    "Phone number must start with +963 followed by exactly 9 digits (e.g., +963958948727).": "يجب أن يبدأ رقم الهاتف بـ +963 يليه 9 أرقام (مثال: +963958948727)."
}
